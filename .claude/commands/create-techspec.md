...
<critical>Activate and follow the `create-techspec` skill to guide the entire Tech Spec creation process. The skill contains the complete procedure, templates, and quality checklists.</critical>
...
- Template: available in `assets/techspec-template.md` inside the skill
