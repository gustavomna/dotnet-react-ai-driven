...
auggie has no Skill tool. Read `.agents/skills/qa-agent/SKILL.md` and follow its procedure, scope resolution rules, stack detection, test generation conventions, execution protocol, findings format, and baseline and suppression governance EXACTLY to guide the entire QA process.

For the accessibility layer, read `.agents/skills/a11y-testing/SKILL.md` and follow it EXACTLY whenever the resolved scope touches UI.
...
- Accessibility skill: `.agents/skills/a11y-testing/SKILL.md`
